...
class CodeInfo:
    ...
    # Are we tracing in this code object?
    tracing: bool

    # The file data we are collecting for this code object.
    file_data: TTraceFileData | None

    # Map of instruction offsets to line numbers.
    byte_to_line: dict[TOffset, TLineNo] | None

    # Keys are possible start instruction offsets for branches.
    # Values are lists:
    #   [
